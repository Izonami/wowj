...
import com.wow.network.gameserverpackets.CMSG_CHAR_CREATE;
import com.wow.network.gameserverpackets.CMSG_MESSAGECHAT;
import com.wow.network.gameserverpackets.CMSG_MOVEMENT;
import com.wow.network.gameserverpackets.CMSG_PLAYER_LOGIN;
import com.wow.network.serverpackets.SMSG_ACCOUNT_DATA_TIMES;
import com.wow.network.serverpackets.SMSG_CHAR_ENUM;
import com.wow.network.serverpackets.SMSG_KNOWN_SPELLS;
import com.wow.network.serverpackets.SMSG_LOGIN_VERIFY_WORLD;
import com.wow.network.serverpackets.SMSG_MESSAGECHAT;
import com.wow.network.serverpackets.SMSG_MOTD;
import com.wow.network.serverpackets.SMSG_MOVE_SET_CANFLY;
import com.wow.network.serverpackets.SMSG_MOVE_UPDATE;
import com.wow.network.serverpackets.SMSG_NAME_CACHE;
import com.wow.network.serverpackets.SMSG_NAME_QUERY_RESPONSE;
import com.wow.network.serverpackets.SMSG_NEW_WORLD;
import com.wow.network.serverpackets.SMSG_PONG;
import com.wow.network.serverpackets.SMSG_REALM_CACHE;
import com.wow.network.serverpackets.SMSG_UPDATE_OBJECT_CREATE;
...
public class WorldSession {
	...
	/**
	 * Send the character list to the gameserverpackets.
	 */
	...
	/**
	 * Creates a character for the gameserverpackets and sets attributes.
	...
	public void createCharacter(CMSG_CHAR_CREATE p) throws UnsupportedEncodingException {
		...
		/* this needs to be sent immediately after previous packet otherwise gameserverpackets fails */
	...
	/**
	 * Synch the serverpackets and gameserverpackets times.
	 */
	...
	/**
	 * Handles a chat message given by the gameserverpackets, checks for commands.
	 */
	...
	/**
	 * Instantly teleports the gameserverpackets to the given coords
	 */
	...
	public void sendRandomName() {
		/* this is temp and should actually come from the gameserverpackets db */
