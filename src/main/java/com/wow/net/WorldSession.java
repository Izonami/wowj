...
import com.wow.net.packets.client.CMSG_CHAR_CREATE;
import com.wow.net.packets.client.CMSG_MESSAGECHAT;
import com.wow.net.packets.client.CMSG_MOVEMENT;
import com.wow.net.packets.client.CMSG_PLAYER_LOGIN;
import com.wow.net.packets.server.SMSG_ACCOUNT_DATA_TIMES;
import com.wow.net.packets.server.SMSG_CHAR_ENUM;
import com.wow.net.packets.server.SMSG_KNOWN_SPELLS;
import com.wow.net.packets.server.SMSG_LOGIN_VERIFY_WORLD;
import com.wow.net.packets.server.SMSG_MESSAGECHAT;
import com.wow.net.packets.server.SMSG_MOTD;
import com.wow.net.packets.server.SMSG_MOVE_SET_CANFLY;
import com.wow.net.packets.server.SMSG_MOVE_UPDATE;
import com.wow.net.packets.server.SMSG_NAME_CACHE;
import com.wow.net.packets.server.SMSG_NAME_QUERY_RESPONSE;
import com.wow.net.packets.server.SMSG_NEW_WORLD;
import com.wow.net.packets.server.SMSG_PONG;
import com.wow.net.packets.server.SMSG_REALM_CACHE;
import com.wow.net.packets.server.SMSG_UPDATE_OBJECT_CREATE;
